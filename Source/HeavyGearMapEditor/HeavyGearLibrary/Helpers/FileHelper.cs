    ...
    public static class FileHelper
    {
        ...
        public static StorageDevice XnaUserDevice
        {
            get
            {
                ...
                if (xnaUserDevice == null && !Guide.IsVisible)
                {
                    AsyncCallback callback = new AsyncCallback(ReturnUserDevice);
                    Guide.BeginShowStorageDeviceSelector(PlayerIndex.One, callback, null);
        ...
        public static void ReturnUserDevice(IAsyncResult result)
        {
            xnaUserDevice = Guide.EndShowStorageDeviceSelector(result);         
        }
            ...
            string filename, FileMode mode, FileAccess access)
        {
            ...
            StorageContainer container =
                XnaUserDevice.OpenContainer("HeavyGear");
